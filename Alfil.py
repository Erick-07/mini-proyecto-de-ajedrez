            ...
            if (casilla_actual + (9*x)) == casilla_destino:
                ...
                if cuenta == x:
                    ...
                    while enable_aux:
                        ...
                        grig_general.gridd = gridd.set_Tablero(self.posicion_destino_fila,self.posicion_destino_columna,self.bando+self.color+str(self.posicion_destino_fila)+str(self.posicion_destino_columna))
